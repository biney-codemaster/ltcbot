...
function buildRulesContainer(howtoChannelId = config.howtoChannelId) {
  ...
  container.addTextDisplayComponents(
    new TextDisplayBuilder().setContent(`# NESTOO - MIDDLEMAN — SERVER RULES`)
  );
...
async function execute(interaction) {
  ...
  await interaction.reply({
    content: `${e("success")}Server rules panel sent.`,
    flags: MessageFlags.Ephemeral,
  });
...
module.exports = { data, execute, buildRulesContainer };
